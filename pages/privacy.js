  ...
  return (
    <div className="bg-black-secondary flex flex-col  font-montserrat px-5">
      ...
      <p className="py-2 text-gray-200">
        ...
        in this privacy policy. The game does use third party services that may
      ...
      <p className="py-2 text-gray-200">
        ...
        However, the game may use third party code and libraries that use
      ...
      <p className="py-2 text-gray-200">
        ...
        our servers and remove their access to our game. If you are a parent or
