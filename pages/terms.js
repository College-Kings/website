  ...
  return (
    <div className="bg-black-secondary flex flex-col px-5 text-white font-montserrat ">
      ...
      <p className="py-2 text-gray-200">
        ...
        availability of 90% (ninety percent). This does not include periods of
        time during which the use and download of our games and other services
        are interrupted or affected due to urgent technical reasons or required
        maintenance work. Crimsonsky LTD is not liable for these instances in
        accordance with the conditions of this contract. This also does not
        include periods of time in which Crimsonsky LTD' general servers or the
        servers of certain games do not allow online access due to reasons
      ...
      <p className="py-2 text-gray-200">
        ...
        form provided at any given time. Crimsonsky LTD retains the right to
      ...
      <p className="py-2 text-gray-200">
        ...
        and the rules of the game, the provisions of these general terms and
        conditions shall take precedence when settling the instance of
        contradiction. In addition, specific terms and conditions shall also
        apply to certain games, specific versions and/or components of our
        games, and individual services offered on Crimsonsky LTD' websites as
      ...
      <p className="py-2 text-gray-200">
        ...
        immediately and change their data or have it changed by Crimsonsky LTD.
        In this case or in the event that Crimsonsky LTD has concrete evidence
        of misuse of data, Crimsonsky LTD has the right to temporarily block
      ...
      <p className="py-2 text-gray-200">
        ...
        explicitly permitted within these general terms and conditions, users
        may not edit, copy, distribute, publicly reproduce, use for advertising
        purposes, or use beyond the contractually agreed purposes any of
        Crimsonsky LTD' websites, mobile games, or the content or any portion
        thereof. Only technical copies intended for browsing purposes and
        permanent copies intended solely for private use shall be permitted.
      ...
      <p className="py-2 text-gray-200">
        ...
        online and mobile games. Users are also required to abstain from any
        measure which may allow unauthorized access to data. Content may only be
        called up in a manner that does not affect other users' use of
      ...
      <p className="py-2 text-gray-200">
        ...
        agreement right to install the client software and use it for the agreed
        purposes according to these general terms and conditions and the rules
        of the respective game. <br />
        <br />
        The software may not be used for commercial purposes in any manner.
        Modifications to the client software and a back-translation of the
        relinquished programming code into other code forms (decompilation) and
        other types of reverse engineering of the software's various production
        levels are prohibited if these are not required for establishing
      ...
      <p className="py-2 text-gray-200">
        ...
        prepare derivative works based upon, or otherwise use or exploit the
        Content. You may download one copy of portions of the Content in
        temporary storage on one personal computer for your personal,
        non-commercial, non-political, non-networked viewing and use only,
        ...
        ownership of any Content. Except as expressly provided above, nothing
        contained in this User Agreement may be construed as conferring to you
      ...
      <p className="py-2 text-gray-200">
        ...
        (particularly discussion forums, chats, blogs, guest books, etc. as well
        as the utilization of their comment functions, altogether known as the
        "communication facilities"), which the user may use when available. In
        this regard, Crimsonsky LTD only provides users with the technical
      ...
      <p className="py-2 text-gray-200">
        ...
        of the users' obligations. Crimsonsky LTD explicitly does not claim
        content entered by users as its own. However, users shall grant
      ...
      <p className="py-2 text-gray-200">
        ...
        against common decency, or breaches the general terms and conditions or
        the rules of the respective game; b) violates trademarks, patents,
        utility or design patterns, copyrights, trade secrets, or other rights
        of third parties; c) is obscene, racist, violent, or otherwise
        threatening to the development of children and adolescents, or of a
        detrimental nature; d) is of an abusive, harassing, or defamatory
        nature; e) includes chain letters or pyramid schemes; f) falsely
        suggests that it is provided or supported by Crimsonsky LTD; g) contains
      ...
      <p className="py-2 text-gray-200">
        ...
        general terms and conditions. Crimsonsky LTD also has the right to
        exclude users who violate these rules, in whole or temporarily, from
      ...
      <p className="py-2 text-gray-200">
        ...
        law, third party rights, these general terms and conditions, or any
        respective additional regulations and game rules: a) remove content, b)
        issue a warning to the user, c) temporarily or permanently block a user
        from specific or all video games and content of Crimsonsky LTD'
        websites, d) suspend a user, also from certain game or community
        functions (e.g. chat) e) issue a temporary or permanent virtual ban from
      ...
      <p className="py-2 text-gray-200">
        ...
        obligations of these terms and conditions. Users release Crimsonsky LTD
        from all eligible claims that other users or third parties may file
        against Crimsonsky LTD due to a violation of their rights by content
        posted by the user or due to a violation of other obligations. Users
        shall assume the costs of Crimsonsky LTD' legal defense, including all
      ...
      <p className="py-2 text-gray-200">
        ...
        slight negligence, however, Crimsonsky LTD will only be liable for a
        breach of essential contractual obligations such as delay or
        unavailability which Crimsonsky LTD is held responsible for. In the case
        of a breach of an essential contractual obligation, liability is limited
        to the typical contractual damages that Crimsonsky LTD had to calculate
        upon conclusion of the contract due to the circumstances prevailing at
        this time. "Essential contractual obligations", as previously stated,
        are the obligations that may be relied upon by the user and that ensure
      ...
      <p className="py-2 text-gray-200">
        ...
        Court, (c) because of technical necessity, (d) in order to maintain
        company operations, (e) in the event of a change in market conditions,
        (f) for the benefit of the user. No amendment will take place if such
        amendment would substantially disrupt the contractual balance between
        the parties. Users will be informed of any amendments to the general
        terms and conditions via the Crimsonsky LTD' website and via the
        respective online or mobile game at least four weeks before the
        amendment is scheduled to take effect. Alternatively, Crimsonsky LTD may
        send its users the amended general terms and conditions via email or
        inform them that the amended general terms and conditions can be
        accessed via the Crimsonsky LTD' websites. The user is entitled to
        object to any amendment within four weeks. The terms and conditions are
        deemed to have been accepted if the user remains silent for the
        four-week period or if the user opens the game again after receiving
        notification of the amended terms and conditions. Crimsonsky LTD will
      ...
      <p className="py-2 text-gray-200">
        ...
        synallagmatic legal relationship. Users can only exercise a right of
      ...
      <p className="py-2 text-gray-200">
        ...
        account specified at registration for messages from Crimsonsky LTD. When
        contacting Crimsonsky LTD, users must indicate which online or mobile
        game and which user account the message concerns. 12.4 Should any
        provision of these terms and conditions be or become invalid and/or
